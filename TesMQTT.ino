...
String wifiSSID = "FA.JAYA";
String wifiPassword = "keluarga123";
...
void loop()
{
    if (!mqtt.connected())
    {
        ...
        mqtt.publish("esp32/temphum/ali", "ESP 32 Online!");
    }
    mqtt.loop();
    mqtt.publish("esp32/temphum/ali", randomTemp().c_str());
    delay(1000);
}
...
void connect_mqtt()
{
    while (!mqtt.connected())
    {
        ...
        {
            mqtt.subscribe("esp32/temphum/ali");
        }
    }
}
